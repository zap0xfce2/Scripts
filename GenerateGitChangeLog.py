...
#
# example:
# ./GenerateGitChangeLog.py ~/MyProject/
# output:
# ~/MyProject/CHANGELOG.txt

import string, re, os, sys

ProjectPath = str(sys.argv[1])
ChangeLogFileName = str("CHANGELOG.txt")

# Execute git log with the desired command line options.
fin = os.popen('cd ' + ProjectPath + '.git && git log --summary --stat --no-merges --date=short', 'r')
# Create a ChangeLog file in the current directory.
fout = open(ProjectPath + ChangeLogFileName, 'w')
